...
//สร้าง obj ควบคุม textfield
  ...
  //สร้าง method แสดง warning message
  ...
  //เปิดจอ showMoneyShare พร้อมข้อมูลที่จะเอาไปแสดง
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Checkbox(
                        onChanged: (param) {
                          //คำสั่งที่มีผลต่อการแสดงผลให้เขียนภายใต้ setstate
                          if (param == false) {
                            setState(() {
                              tipCtrl.text = '';
                            });
